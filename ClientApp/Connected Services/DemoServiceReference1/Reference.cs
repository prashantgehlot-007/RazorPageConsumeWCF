...
namespace DemoServiceReference1
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DemoServiceReference1.IDemoService")]
    public interface IDemoService
    {
        ...
        System.Threading.Tasks.Task<double> SumAsync(double number1, double number2);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface IDemoServiceChannel : DemoServiceReference1.IDemoService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class DemoServiceClient : System.ServiceModel.ClientBase<DemoServiceReference1.IDemoService>, DemoServiceReference1.IDemoService
    {
        ...
        public System.Threading.Tasks.Task<double> SumAsync(double number1, double number2)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IDemoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:57246/DemoService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
